...
class LinearSchedule(object):
    def __init__(self, schedule_timesteps, final_p, initial_p=1.0):
        ...
        200000， 0.1
        """
        print(" ..... LOAD DDQN LINEARSCHDULE ......")
        self.schedule_timesteps = schedule_timesteps       # 200000
        self.final_p            = final_p                  # 0.1
        self.initial_p          = initial_p                # 1
